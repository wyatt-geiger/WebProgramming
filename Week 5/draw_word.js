...
input.addEventListener("input", function(){
    ...
    context.drawImage(image,0,0);
    context.font = "30px Arial Black" // set font (Arial Black is the literal name of the font)
    context.fillStyle = "White" // set the color of the font
